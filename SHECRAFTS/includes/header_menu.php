...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.8)">
            <div class="container">
            ...
            <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script> -->
                    ...
                    <a href="index.php" class="navbar-brand">SheCrafts</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   ...
                                   <a href="products.php#cloths" class="dropdown-item">Cloths</a>
                                   <a href="products.php#crafts" class="dropdown-item">Crafts</a>
                                   <a href="products.php#decorations" class="dropdown-item">Decorations</a>
                               </div>
